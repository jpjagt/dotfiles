...
(defgroup my-doom-palenight-theme nil
  "Options for doom-themes"
  :group 'doom-themes)

(defcustom my-doom-palenight-padded-modeline doom-themes-padded-modeline
  "If non-nil, adds a 4px padding to the mode-line.
Can be an integer to determine the exact padding."
  :group 'my-doom-palenight-theme
  :type '(choice integer boolean))

;; WARNING: this theme is inactive
(def-doom-theme my-doom-palenight
  "Custom version of doom-palenight theme"
  ...
  (((lazy-highlight &override) :background base4 :foreground fg :distant-foreground fg :bold bold)
   ...
   ((org-block-begin-line &override) :background base2  :underline t)
...
(provide 'my-doom-palenight-theme)
