...
#+BEGIN_SRC emacs-lisp
(add-to-list 'load-path "~/.emacs.d/repos/gptel")
(require 'gptel)
(require 'gptel-curl)
...
(defun chat ()
  ...
  (run-with-idle-timer
   0.1 nil ;; Adjust the delay time as needed.
   (lambda ()
