(custom-set-variables
 ...
 '(package-selected-packages
   '(easy-kill exwm tide rjsx-mode scss-mode js-format htmlize smooth-scroll smooth-scrolling slack neotree ts org-mime oauth2 auctex-lua request auctex srefactor emojify-logos call-graph indium wiki-summary simple-call-tree google-this undo-tree smartparens swoop tree-mode magit swiper-helm counsel-tramp tramp-term use-package))
