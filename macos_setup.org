...
brew install --cask deluge # torrent client
brew install --cask soulseek # share files
#+END_SRC
...
pipx ensurepath
pipx install virtualenvwrapper uv ruff album-splitter black fire flake8 ipdb ipython matplotlib numpy pandas pytest yt-dlp
#+END_SRC

* cursor setup

see [[file:cursor_setup.org]].
